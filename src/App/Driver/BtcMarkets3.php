    ...
    public function describe()
    {
        return array_replace_recursive(parent::describe(), array(
            ...
            'urls' => array(
                ...
                'api' => array(
                    'public' => 'https://api.btcmarkets.net/v3',
                    'private' => 'https://api.btcmarkets.net/v3',
                    'web' => 'https://btcmarkets.net/data',
                ),
                'www' => 'https://btcmarkets.net/',
                'doc' => 'https://api.btcmarkets.net/doc/v3',
            ),
            'api' => array(
                'public' => array(
                    'get' => array(
            ...
            'markets' => array(
                ...
                'ENJ/AUD' => array('id' => 'ENJ/AUD', 'symbol' => 'ENJ/AUD', 'base' => 'ENJ', 'quote' => 'AUD', 'maker' => 0.0085, 'taker' => 0.0085, 'limits' => array('amount' => array('min' => 0.001, 'max' => null)), 'precision' => array('price' => 2)),
                ...
                'ENJ/BTC' => array('id' => 'ENJ/BTC', 'symbol' => 'ENJ/BTC', 'base' => 'ENJ', 'quote' => 'BTC', 'maker' => 0.0022, 'taker' => 0.0022, 'limits' => array('amount' => array('min' => 0.001, 'max' => null))),
            ),
            'timeframes' => array(
                '1m' => 'minute',
                '1h' => 'hour',
